                ...
                <div className="mx-auto w-full max-w-7xl px-5 my-8 md:px-10 md:my-14">
                    ...
                    <div className="">
                        ...
                        >
                            ...
                            <a href="#" className="rounded-lg mr-5 flex w-full items-center justify-center bg-blue px-8 py-4 font-semibold text-white transition md:mr-6 lg:mr-8">
                                <p className="mr-6 font-bold">Lets Talk</p>
                                <svg
                                    fill="currentColor"
                                    viewBox="0 0 20 21"
